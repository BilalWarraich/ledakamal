...
createChannelGenesisBlock() {
  setGlobals bloodcollection peer0
	which configtxgen
	if [ "$?" -ne 0 ]; then
...
joinChannel bloodcollection peer0
joinChannel bloodcollection peer1

infoln "Joining org2 peer to the channel..."
joinChannel bloodprocessing peer0
joinChannel bloodprocessing peer1

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for org1..."
setAnchorPeer bloodcollection peer0
infoln "Setting anchor peer for org2..."
setAnchorPeer bloodprocessing peer0
