...
fetchChannelConfig bloodcollection ${CHANNEL_NAME} ${TEST_NETWORK_HOME}/channel-artifacts/config.json peer0
...
signConfigtxAsPeerOrg bloodcollection ${TEST_NETWORK_HOME}/channel-artifacts/org3_update_in_envelope.pb peer0
